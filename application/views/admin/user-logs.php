...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active"><i class="fa fa-users"></i> User Logs</a></li>
		</ol>
	</section>
	<br>
	...
	<div class="box box-default" >
		<div class="box-header with-border">
			<h3 class="box-title">List of User Logs</h3>
		...
		<div class="box-body">
			<section class="content">
				<div class="row">
					<div class="col-xs-12">
						<div class="box-body">
							<table id="tblUserLogs" class="table table-bordered table-striped table-hover">
								<thead>
									<tr>
										<!-- <th></th> -->
										<th rowspan="1">LogID</th>
										<th rowspan="1">Username</th>
										<th rowspan="1">User Type</th>
										<th rowspan="1">Login Time</th>
										<th rowspan="1">Logout Time</th>
...
<script type="text/javascript">
	...
	{
		var table = $('#tblUserLogs').DataTable(
		{
			"pageLength": 10,
			"scrollX": true,
			"order": [[ 0, "desc" ]],
			...
			"ajax": 
			{
				url : "<?php echo site_url("accounts_controller/load_ulogs_table") ?>",
				type : 'POST'
			},
			"dom": 'Bfrtip',
			"buttons": 
	...
	{
		var serialize;
		serialize = "txtName=" + "&modulefeature=User Logs" + "&id=" + id;

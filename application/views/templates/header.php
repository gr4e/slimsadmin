...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url()."assets/"; ?>css/bedlam.css">
	...
	<link rel="stylesheet" href="<?php echo base_url()."assets/"; ?>css/tabbing.css">
	...
	<script src="<?php echo base_url()."assets/"; ?>js/buttons.html5.js"></script>
	<script src="<?php echo base_url()."assets/"; ?>js/buttons.print.min.js"></script>
	<script src="<?php echo base_url()."assets/"; ?>js/buttons.colVis.min.js"></script>
	<script src="<?php echo base_url()."assets/"; ?>js/dataTables-rowsgroup.min.js"></script>
		...
		<header class="main-header">
			...
			<a href="<?php echo base_url()."admin/updateprofile"; ?>" class="logo">
				...
				<span class="logo-mini"><b>SLIMS</span>
					...
					<nav class="navbar navbar-static-top">
							...
							<ul class="nav navbar-nav">
								...
								<li class="dropdown messages-menu">
									...
									<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="height:50px;">
										...
										<span class="label label-success" id="notifCount"></span>
									</a>

									<ul  class="dropdown-menu">
										<li class="header">Private Messages</li>
										<li>

											<ul class="menu" id="notifMsg">

											</ul>

										</li>
										<li class="footer"><a href="<?php echo site_url('PrivateMsg/Pmsg');?>">View all</a></li>
									</ul>
								</li>
								...
								$(document).ready(
									function() {
										...
										$.ajax({
											type: "POST",
											dataType: "json",
											url: "<?php echo base_url(); ?>index.php/Notif_controller/pvt_Msgs",
											success: function(data){
												$('#notifMsg').html(data.messages);
									...
									<li class="dropdown notifications-menu">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="height:50px;">
											...
											<span class="label label-info" id="otherNotifCount"></span>
										</a>

										<ul  class="dropdown-menu">
											<li class="header">Other Notifications</li>
											<li>

												<ul class="menu">
													<li id="aal" onclick="location.href='<?php echo base_url(); ?>Notif_controller/Notify/aal'">
													</li>
													<li id="sab" onclick="location.href='<?php echo base_url(); ?>Notif_controller/Notify/sab'">
													</li>
												</ul>

											</li>
											<li class="footer"><a href="<?php echo site_url('CMS/Notify');?>">View all</a></li>
										</ul>
									</li>
									<!-- other notif -->
									...
									$(document).ready(
										function() {
											...
											$.ajax({
												type: "POST",
												dataType: "json",
												url: "<?php echo base_url(); ?>index.php/Notif_controller/GET_otherNotif",
												success: function(data){
													$('#otherNotifCount').html(data.otherNotifCount);
													$('#aal').html(data.aal);
													$('#sab').html(data.sab);
												}
											});
						...
						<aside class="main-sidebar">
								...
								<ul class="sidebar-menu" data-widget="tree">
									...
									<li class="treeview <?php echo $acquisition ?>">
										...
										<ul class="treeview-menu">
											...
											<li><a href="<?php echo base_url()."acquisitions/monitoring_serial"; ?>" style="letter-spacing:-0.9px;"><i class="fa fa-search-plus"></i> Monitoring of Serial Materials</a></li>
										</ul>
									</li>
							...
							<li class="treeview <?php echo $circulation ?>">
								<a href="#">
									<i class="fa fa-book"></i> <span>Content Management</span>
									<span class="pull-right-container">
										<i class="fa fa-angle-left pull-right"></i>
									</span>
								</a>
							...
							<li class="treeview <?php echo $circulation ?>">
								<a href="#">
									<i class="fa fa-refresh"></i> <span>Circulation</span>
									<span class="pull-right-container">
										<i class="fa fa-angle-left pull-right"></i>
									</span>
								</a>
						...
						<ul class="sidebar-menu" data-widget="tree">
							...
							<li>
								<a href="<?php echo site_url('manuals');?>">
									<i class="fa fa-book"></i> <span>Users Manual</span>
								</a>
							</li>
						</ul>
						...
						<ul class="sidebar-menu" data-widget="tree">
							...
							<li class="treeview <?php echo $admin ?>">
								...
								<ul class="treeview-menu">
									<li class="<?php echo $others ?>"><a href="<?php echo base_url()."admin/ServerSettings"; ?>"><i class="fa fa-gear"></i>Server Settings</a></li>
									<li class="<?php echo $accounts ?>"><a href="<?php echo base_url()."admin/accounts"; ?>"><i class="fa fa-user-plus"></i> Account Management</a></li>
									<li class="<?php echo $others ?>"><a href="<?php echo base_url()."admin/PatronAccounts"; ?>"><i class="fa fa-address-card-o"></i> Patron Management</a></li>
									<li class="<?php echo $others ?>"><a href="<?php echo base_url()."admin/groups"; ?>"><i class="fa fa-users"></i> Group Management</a></li>
									<li class="<?php echo $others ?>"><a href="<?php echo base_url()."admin/consortia"; ?>"><i class="fa fa-institution"></i> Consortia Members</a></li>
									...
									<li class="treeview <?php echo $others ?>">
										<a href="#">
										...
										<ul class="treeview-menu">
											<li><a href="<?php echo base_url()."admin/transactionlogs"; ?>"><i class="fa fa-gear"></i> Transaction Logs</a></li>
											<li><a href="<?php echo base_url()."admin/userlogs"; ?>"><i class="fa fa-users"></i> User Logs</a></li>
										</ul>
									</li>
								</ul>
							</li>
				...
				*/
				...
				//setting of server current IP
				$(document).ready(function(){
					$.ajax({
						type: "POST",
						dataType: "json",
						url: "<?php echo base_url(); ?>Cms_controller/checkServerIP"
					}).done(function(data){

						if(data.NoIp == '1'){

							swal("Please input the current server IP here:", {
								content: "input",
								button: {text: "Set IP"}
							})
							.then((value) => {
								...
								$.ajax({
									...
									dataType: "json",
									data: {ip: value},
									url: "<?php echo base_url(); ?>Cms_controller/setServerIP"
								}).done(function(data) {
									swal("Server IP set!", "", "success");
								});

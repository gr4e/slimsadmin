									...
									<li class="dropdown notifications-menu">
										...
										<ul  class="dropdown-menu">
											...
											<li>
												...
												<ul class="menu">
													<li id="ctl" onclick="location.href='<?php echo base_url(); ?>Notif_controller/Notify/ctl'">
													</li>
						...
						<aside class="main-sidebar">
							...
							<li class="treeview <?php echo $circulation ?>">
								...
								<ul class="treeview-menu">
									...
									<li><a href="<?php echo base_url()."CMS/news"; ?>"><i class="fa fa-plus-square"></i>Manage News</a></li>
